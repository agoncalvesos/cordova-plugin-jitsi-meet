...
module.exports = function (ctx) {
  ...
  /**
   * Recursively search for file with the given filter starting on startPath
   */
  ...
  proj.parseSync();
  addFramework("JitsiMeet.framework.framework",proj);
  addFramework("WebRTC.framework",proj);
